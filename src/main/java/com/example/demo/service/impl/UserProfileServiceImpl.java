...
public class UserProfileServiceImpl implements UserProfileService {
  ...
  public UserProfile createUser(UserProfile profile) {
    ...
    if (profile.getUserId() == null || profile.getUserId().isBlank())
      profile.setUserId("U" + System.currentTimeMillis());

    if (repo.existsByEmail(profile.getEmail()) || repo.existsByUserId(profile.getUserId()))
      throw new BadRequestException("Duplicate email/userId");
